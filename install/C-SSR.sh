...
Separator_1="\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224"

check_root() {
	[[ $EUID != 0 ]] && echo -e "${Error} La cuenta actual no es ROOT (no tiene permiso ROOT), no puede continuar la operacion, por favor ${Green_background_prefix} sudo su ${Font_color_suffix} Venga a ROOT (le pedire que ingrese la contrase\303\261a de la cuenta actual despues de la ejecucion)" && exit 1
}
check_sys() {
...
#Leer la informaci\357\277\275n de configuraci\357\277\275n
Get_IP() {
...
View_User_info() {
	...
	echo -e " Contrase\303\261a : ${Green_font_prefix}${password}${Font_color_suffix}"
...
#Modificar la informaci\357\277\275n de configuraci\357\277\275n
...
Modify_config_protocol() {
	...
	if [[ -z "${match_edit}" ]]; then
		...
		echo -e "${Info} Acuerdo de usuario modificacion exito ${Green_font_prefix}[Port: ${ssr_port}]${Font_color_suffix} (Nota: la configuracion m\357\277\275s reciente puede demorar unos 10 segundos)"
	fi
}
Modify_config_obfs() {
...
Modify_config_protocol_param() {
	...
	if [[ -z "${match_edit}" ]]; then
		...
		echo -e "${Info} Parametros de negociaci\357\277\275n del usuario (numero de dispositivos limite) modificados correctamente ${Green_font_prefix}[Port: ${ssr_port}]${Font_color_suffix} (Nota: puede tomar aproximadamente 10 segundos aplicar la ultima configuracion)"
	fi
}
...
Modify_config_speed_limit_per_user() {
	...
	if [[ -z "${match_edit}" ]]; then
		echo -e "${Error} Usuario Puerto la modificaci\357\277\275n del limite de velocidad total fallo ${Green_font_prefix}[Port: ${ssr_port}]${Font_color_suffix} " && exit 1
	else
...
Download_SSR() {
	...
	# unzip "manyuser.zip"
	# [[ ! -e "/usr/local/shadowsocksr-manyuser/" ]] && echo -e "${Error} Fallo la descompresi\357\277\275n del servidor ShadowsocksR !" && rm -rf manyuser.zip && exit 1
...
Update_SSR() {
	SSR_installation_status
	# echo -e "Debido a que el beb\357\277\275 roto actualiza el servidor ShadowsocksR, entonces."
	cd ${ssr_folder}
	git pull
	Restart_SSR
...
#Mostrar informaci\357\277\275n de conexi\357\277\275n
...
#Modificar la configuraci\357\277\275n del usuario
Modify_port() {
	msg -bar
	List_port_user
	while true; do
...
Modify_Config() {
	clear
	SSR_installation_status
	echo && echo -e "    ###\302\277Que desea realizar?###
$(msg -bar)
...
\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224 Modificar la Configuracion del Usuario \342\200\224\342\200\224\342\200\224\342\200\224
...
\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224 Otras Configuraciones \342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224
...
Del_port_user() {
	...
	while true; do
		...
		if [[ ! -z ${del_user} ]]; then
			...
			if [[ -z "${match_del}" ]]; then
				echo -e "${Error} La eliminaci\303\263n del usuario fall\303\263 ${Green_font_prefix}[Puerto: ${del_user_port}]${Font_color_suffix} "
			else
				Del_iptables
				Save_iptables
...
Clear_transfer_one() {
	...
	while true; do
		msg -bar
		echo -e "Por favor ingrese el puerto de usuario para borrar el tr\303\241fico usado"
		...
		if [[ ! -z ${Clear_transfer_user} ]]; then
			...
			if [[ -z "${match_clear}" ]]; then
				echo -e "${Error} El usuario no ha podido utilizar la compensaci\303\263n de tr\303\241fico ${Green_font_prefix}[Puerto: ${Clear_transfer_user_port}]${Font_color_suffix} "
			else
				echo -e "${Info} El usuario ha eliminado con \303\251xito el tr\303\241fico utilizando cero. ${Green_font_prefix}[Puerto: ${Clear_transfer_user_port}]${Font_color_suffix} "
			fi
			break
		else
			echo -e "${Error} Por favor ingrese el puerto correcto !"
...
$(msg -bar)
 ${Green_font_prefix} 0 2 15 * * ${Font_color_suffix} Representativo El 1  2} representa el 15  2:00 minutos Punto de flujo usado despejado 0 minutos Borrar flujo usado\357\277\275
$(msg -bar)
...
\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224
...
RestaurarBackUp_ssrr() {
	...
	read -p "     \342\226\272\342\226\272 Presione enter para continuar \342\227\204\342\227\204"
	msg -bar
	msg -azu "$(fun_trans "Procedimiento Hecho con Exito")"
	read -p "  \342\226\272\342\226\272 Presione enter para Reiniciar Panel SSRR \342\227\204\342\227\204"
	msg -bar
...
\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224
...
\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224
  ...
  \342\200\224\342\200\224 Modo bajo o verboso..
  ${Green_font_prefix}7.${Font_color_suffix} Supervisar el estado de ejecucion del servidor ShadowsocksR
  \342\200\224\342\200\224 NOTA: Esta funcion es adecuada para que el servidor SSR finalice los procesos regulares. Una vez que esta funcion esta habilitada, sera detectada cada minuto. Cuando el proceso no existe, el servidor SSR se inicia automaticamente.
\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224 
...
#Prohibido\357\277\275BT PT SPAM
BanBTPTSPAM() {
...
Set_config_connect_verbose_info() {
	...
	if [[ ${connect_verbose_info} = "0" ]]; then
		...
		msg -bar
		echo -e "yes para cambiar a ${Green_font_prefix}Modo detallado (registro de conexi\357\277\275n + registro de errores)${Font_color_suffix}\357\274\237[y/N]"
		msg -bar
...
\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224\342\200\224
