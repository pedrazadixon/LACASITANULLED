...
[[ ! -e "/bin/ShellBot.sh" ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/lacasitamx/BOT/ShellBot.sh &>/dev/null
