...
libsodium_url="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/libsodium/Libso/libsodium-1.0.18.tar.gz"
...
shadowsocks_python_centos="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocks"
shadowsocks_python_debian="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocks-debian"

shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="https://github.com/shadowsocksrr/shadowsocksr/archive/3.2.2.tar.gz"
shadowsocks_r_init="/etc/init.d/shadowsocks-r"
shadowsocks_r_config="/etc/shadowsocks-r/config.json"
shadowsocks_r_centos="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocksR"
shadowsocks_r_debian="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocksR-debian"
...
shadowsocks_go_centos="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocks-go"
shadowsocks_go_debian="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocks-go-debian"

shadowsocks_libev_init="/etc/init.d/shadowsocks-libev"
shadowsocks_libev_config="/etc/shadowsocks-libev/config.json"
shadowsocks_libev_centos="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocks-libev"
shadowsocks_libev_debian="https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/shadowsocks_install/shadowsocks-libev-debian"
...
install_prepare_password() {
	echo "Por favor, introduzca la contrase\303\261a para ${software[${selected} - 1]}"
	read -p "(Default Contrase\303\261a: lacasitamx):" shadowsockspwd
	[ -z "${shadowsockspwd}" ] && shadowsockspwd="lacasitamx"
	msg -bar
	echo "Contrase\303\261a = ${shadowsockspwd}"
	msg -bar
}
...
install_prepare_cipher() {
	while true; do
		...
		if [[ "${selected}" == "1" || "${selected}" == "4" ]]; then
			...
			msg -bar
			read -p "\302\277Qu\303\251 cifrado elegir\303\255as?(Default: ${common_ciphers[0]}):" pick
			[ -z "$pick" ] && pick=1
			...
			msg -bar
			read -p "\302\277Qu\303\251 cifrado elegir\303\255as?(Default: ${r_ciphers[1]}):" pick
			[ -z "$pick" ] && pick=2
			expr ${pick} + 1 &>/dev/null
			if [ $? -ne 0 ]; then
				echo -e "[${red}Error${plain}] Please enter a number"
			...
			msg -bar
			read -p "\302\277Qu\303\251 cifrado elegir\303\255as?(Default: ${go_ciphers[0]}):" pick
			[ -z "$pick" ] && pick=1
			expr ${pick} + 1 &>/dev/null
			if [ $? -ne 0 ]; then
				echo -e "[${red}Error${plain}] Please enter a number"
...
install_prepare_obfs() {
	while true; do
		...
		msg -bar
		read -p "Qu\303\251 objs elegir\303\255as(Default: ${obfs[0]}):" r_obfs
		[ -z "$r_obfs" ] && r_obfs=1
	...
	if autoconf_version || centosversion 6; then
		...
		if [ "${libev_obfs}" == "y" ] || [ "${libev_obfs}" == "Y" ]; then
			while true; do
				...
				msg -bar
				read -p "Qu\303\251 objs elegir\303\255as(Default: ${obfs_libev[0]}):" r_libev_obfs
...
install_libsodium() {
	if [ ! -f /usr/lib/libsodium.a ]; then
		cd /tmp/
		wget https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/libsodium/Libso/libsodium-1.0.18.tar.gz
...
install_mbedtls() {
	if [ ! -f /usr/lib/libmbedtls.a ]; then
		...
		wget https://raw.githubusercontent.com/pedrazadixon/LACASITANULLED/main/ZETA/sha//mbedtls-2.16.0.tgz
...
install_completed_python() {
	...
	msg -bar
	echo -e "Felicidades, ${green}${software[0]}${plain} instalaci\303\263n del servidor completada!"
...
install_completed_r() {
	...
	msg -bar
	echo -e "Felicidades, ${green}${software[1]}${plain} instalaci\303\263n del servidor completada!"
	echo -e "Tu Server IP        : ${red} $(get_ip) ${plain}"
	echo -e "Tu Server Port      : ${red} ${shadowsocksport} ${plain}"
	echo -e "Tu Password         : ${red} ${shadowsockspwd} ${plain}"
...
install_completed_go() {
	...
	msg -bar
	echo -e "Felicidades, ${green}${software[2]}${plain} instalaci\303\263n del servidor completada!"
	echo -e "Tu Server IP        : ${red} $(get_ip) ${plain}"
	echo -e "Tu Server Port      : ${red} ${shadowsocksport} ${plain}"
	echo -e "Tu Password         : ${red} ${shadowsockspwd} ${plain}"
	echo -e "Tu Encryption Method: ${red} ${shadowsockscipher} ${plain}"
...
install_completed_libev() {
	...
	msg -bar
	echo -e "Felicidades, ${green}${software[3]}${plain} instalaci\303\263n del servidor completada!"
	echo -e "Tu Server IP        : ${red} $(get_ip) ${plain}"
	echo -e "Tu Server Port      : ${red} ${shadowsocksport} ${plain}"
	echo -e "Tu Password         : ${red} ${shadowsockspwd} ${plain}"
	if [ "$(command -v obfs-server)" ]; then
...
uninstall_shadowsocks_python() {
	printf "Est\303\241s seguro de desinstalar ${red}${software[0]}${plain}? [y/n]\\n"
...
uninstall_shadowsocks_r() {
	printf "Est\303\241s seguro de desinstalar ${red}${software[1]}${plain}? [y/n]\\n"
	read -p "(default: n):" answer
	[ -z ${answer} ] && answer="n"
	if [ "${answer}" == "y" ] || [ "${answer}" == "Y" ]; then
...
uninstall_shadowsocks_go() {
	printf "Est\303\241s seguro de desinstalar ${red}${software[2]}${plain}? [y/n]\\n"
	read -p "(default: n):" answer
	[ -z ${answer} ] && answer="n"
	if [ "${answer}" == "y" ] || [ "${answer}" == "Y" ]; then
...
uninstall_shadowsocks_libev() {
	printf "Est\303\241s seguro de desinstalar ${red}${software[3]}${plain}? [y/n]\\n"
	read -p "(default: n):" answer
	[ -z ${answer} ] && answer="n"
	if [ "${answer}" == "y" ] || [ "${answer}" == "Y" ]; then
...
unsha() {
	while true; do
		echo "\302\277Qu\303\251 servidor de Shadowsocks quieres desinstalar?"
		msg -bar
		...
		msg -bar
		read -p "Por favor, introduzca un n\303\272mero[1-4]:" un_select
		case "${un_select}" in
		1 | 2 | 3 | 4)
			msg -bar
